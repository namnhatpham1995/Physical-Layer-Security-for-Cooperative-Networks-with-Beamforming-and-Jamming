...
%end
dRD=5:30;
x=plot(dRD,avgRsdf,'-o');
x.LineWidth=2;
hold on;
y=plot(dRD,avgRsaf,'-x');
y.LineWidth=2;
hold off;
title('\fontsize{18}Average secrecy rate vs relay-destination distance');
xlabel('\fontsize{18}Relay-destination distance (m)');
